...
public interface UserService {
    ...
    DistributionLevelOverviewResponse getDistributionLevelOverview(Long userId);
    InviterResponse getInviter(Long userId);
    java.util.List<TeamMemberResponse> getDirectInvitees(Long userId);
    java.util.List<TeamMemberResponse> getIndirectInvitees(Long userId);
    Long getTeamTotal(Long userId);
